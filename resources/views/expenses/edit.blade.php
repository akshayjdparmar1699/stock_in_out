            ...
            <div class="bg-white shadow-sm rounded-lg p-6">
                <form method="POST" action="{{ route('expenses.update', $expense) }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select id="staff_member_id" name="staff_member_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            @foreach ($staffOptions as $member)
                                <option value="{{ $member->id }}" @selected((string) old('staff_member_id', $expense->staff_member_id) === (string) $member->id)>
                    ...
                    <div>
                        ...
                        <x-text-input id="note" name="note" type="text" class="mt-1 block w-full" :value="old('note', $expense->note)" />
