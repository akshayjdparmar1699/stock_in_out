...
<div x-show="confirmOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display: none;">
    ...
    <div x-show="confirmOpen"
        ...
        <p class="text-sm text-gray-500 mt-2">
            <span x-show="confirmActive" x-text="confirmName + ' {{ __('will not show up in the expenses list for new entries until you activate them again.') }}'"></span>
            <span x-show="!confirmActive" x-text="confirmName + ' {{ __('will become available again for recording expenses.') }}'"></span>
        </p>
